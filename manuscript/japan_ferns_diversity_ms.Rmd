...
In the summary of species richness in 10 km-grids excluding nothotaxa (Fig. 1a), the grids with the highest (`r highest_richness_cell_n_taxa` taxa, grid code: `r highest_richness_cell`) and the second highest diversity (`r highest_richness_cell_n_taxa_2` taxa, grid code: `r highest_richness_cell_2`) are found in the mountain area of Yakushima Island, located south of Kyushu including the island’s highest peak (Mt. Miyanoura, 1936 m in elevation). The third highest grid (`r highest_richness_cell_n_taxa_3` taxa, grid code `r highest_richness_cell_3`) is located in the area covering Nachi-no-taki Falls in southern part of Wakayama Prefecture, southern Honshu.
